...
class ArmMover:
    ...
    def execute(self):
        ...
        # Calculate arm error
        arm_err = self.arm_base_speed * self.config["arm"][
            "max_pos_speed"] - arm_pos_speed
        if self.arm_enabled:
        ...
        wrist_err = self.wrist_base_speed * self.config["wrist"][
            "max_pos_speed"] - wrist_pos_speed
